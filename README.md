...
1) Download h2-console.war from  https://github.com/jboss-developer/jboss-eap-quickstarts/blob/7.1.0.GA/h2-console/h2-console.war
...
5) Execute the following statments
        ...
        1) ALTER TABLE VARIABLEINSTANCELOG MODIFY OLDVALUE VARCHAR(10000);
 
 
Model Project : (This project has all the data types and java util methods which will be invoked from BPMN process.)
 
git clone https://github.com/arunhari82/DocumentProcessingDMN-model.git
...
https://github.com/arunhari82/DMNRulesDemo.git
